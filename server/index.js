...
const connectDB = () => {
    ...
    pool.connect((err, client, release) => {
        if (err) {
            // Check for specific error types and log them
            if (err.message.includes('database "sauron" does not exist')) {
                console.error('Database "sauron" does not exist. Ensure it is created.');
            } else if (err.message.includes('password authentication failed')) {
                console.error('Password authentication failed. Check your PGUSER or PGPASSWORD in the environment variables.');
            } else if (err.message.includes('role "postgres" does not exist')) {
                console.error('Role "postgres" does not exist. Ensure the user and role are correct.');
            } else {
            ...
            release(); // Make sure to release the client after using it
        }
    });
}
