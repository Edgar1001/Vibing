    ...
    <section className="flex-grow py-10 bg-purple-200">
		{/* SORT BY */}
			<div style={{margin: '3vw'}}>
				...
				<ul className="items-center w-full text-sm font-medium text-gray-900 bg-purple-100 border border-gray-200 rounded-lg sm:flex dark:bg-gray-700 dark:border-gray-600 dark:text-white">
