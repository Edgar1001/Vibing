...
function Logout({ loggedIn, setLoggedIn }) {
	...
	// return null;
	return (
		<section className="relative flex-grow py-10 overflow-hidden bg-blue-100 lg:min-h-screen lg:py-10 relative-will-change">
		{/* <form onSubmit={registerTwo}> */}
		  <div className="container px-4 py-10 mx-auto">
        <div className="h-full overflow-hidden rounded-md border-[3px] border-indigo-900 bg-purple-200 p-6">
