...
function useRegisterTwo(itsMe) {
  ...
  axios.defaults.withCredentials = true; // for sessions
    ...
    if ((genderReg !== 'Select One' && seekingReg !== 'Select One') && (
      bioReg.length > 0 && bioReg.length < 500 && bioReg.match(/^[a-zA-Z0-9 _.!@-]+$/))) {
      await axiosStuff
      ...
      that your bio length is 1-500 characters and only contains characters a-z and A-Z
      and " _.!@-"`)
    }
   }
...
function RegisterTwo({ itsMe }) {
  ...
  return (
    <div className="flex-grow py-10 overflow-hidden bg-purple-200 lg:min-h-screen lg:py-10">
		{/* <form onSubmit={registerTwo}> */}
		  <div className="container px-4 py-10 mx-auto">
        <div className="h-full overflow-hidden rounded-md border-[3px] border-indigo-900 bg-purple-100 p-6">
